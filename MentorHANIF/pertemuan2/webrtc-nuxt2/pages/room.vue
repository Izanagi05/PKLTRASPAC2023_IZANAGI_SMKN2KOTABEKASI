        ...
        >
            ...
            <div v-if="layarkondisiScreen == 1">
              <div v-if="localStreamScreen !== null">
                <video
                  ...
                  playsinline
                ></video>
                <div v-if="layarkondisiVideoInScreem !== null">
                  <video
                    rounded-lg
          ...
          <v-card class="grey lighten-5 pa-2 mt-4 rounded-xl" lg="">
            <div class="d-flex justify-center">
              ...
              <v-btn v-if="btnscreen" @click="startScreenKu('Screen')" fab small class="mx-2"
                ><v-icon color="#7b5037" size="20"
                  >mdi-monitor-share</v-icon
                ></v-btn
              >
                <v-btn v-else @click="ScreenKuStop()" fab small class="mx-2"
                  ><v-icon color="#7b5037" size="20"
...
export default {
  data() {
    return {
      ...
      layarkondisiVideoInScreem: null,
  ...
  methods: {
      ...
      navigator.mediaDevices
        ...
        .then((stream) => {
          ...
          if (this.btnvid === true) {
            ...
            this.layarkondisiVideoInScreem=null
    ...
    startScreenKu(param) {
      ...
      navigator.mediaDevices
        ...
        .then((stream) => {
          ...
          this.layarkondisi = -1;
          if (this.btnscreen === false) {
            if(this.layarkondisi==1 ||this.layarkondisi==-1){
              this.layarkondisiVideoInScreem = 1;
            }else{
              this.layarkondisiVideoInScreem = null;
    ...
    ScreenKuStop() {
      if (this.localStreamScreen) {
        ...
        this.btnscreen = !this.btnscreen;;
        this.layarkondisiScreen = 0;
        // if(this.layarkondisiVideoInScreem !==null){
    ...
    joinRoom() {
      ...
      // ];
      const streamsToShare = this.localStreamVideo
      if (this.room) {
        this.room.replaceStream(streamsToShare);
        return;
      }
      this.room = peer.joinRoom(this.$route.query.roomId, {
        mode: "mesh",
        stream: streamsToShare,
      });
      ...
      this.room.on("stream", async (stream) => {
        ...
        console.log("pp" + JSON.stringify(this.peers));
      });
    },
  },
  destroyed() {
