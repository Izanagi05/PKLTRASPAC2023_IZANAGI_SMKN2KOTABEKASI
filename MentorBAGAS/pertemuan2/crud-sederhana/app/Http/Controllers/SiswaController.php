...
class SiswaController extends Controller
{
    ...
    public function exportpdf(){
        ...
        $html ='<h1>Data siswa dengan pelajarannya</h1>
        <table border="1">
        <tr>
        <td><h2> Nama</h2></td>
        <td><h2> Nis</h2></td>
        <td><h2> Alamat</h2></td>
        <td><h2> Lahir</h2></td>
        <td><h2> Pelajaran yang diminati</h2></td>
        </tr>
        ';
         foreach ($data as $key => $siswa) {
            ...
            foreach ($siswa->Pelajaran as $key => $pljrn) {

               $html.= $pljrn->nama_pelajaran;
            }
        ...
        $pdf->save(app()->basePath('public/datasiswa/' . $pdfname));
