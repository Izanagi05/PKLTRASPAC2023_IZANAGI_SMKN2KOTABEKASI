...
if($_POST['submit']??''){
    ...
    for ($j = 0; $j < strlen($kataDtbs); $j++) {
        ...
        $frekuensiHurufTypo[$t][$hurufDtbs] = substr_count($kalimatStrReplaceTypo, $hurufDtbs);
    }
...
$indextertinggi = array_search($caritertinggi, $Hasilawal);

$prediksiAkhir=$kalimatPisah[$indextertinggi];
echo "<pre><br><hr>";
echo "<br>";
...
<body>
    <form action="test2.php" method="post">
        ...
        <br>
        prediksi kata yang benar :<b> <?php echo $prediksiAkhir ?></b>
        <br>
