<template>
  <div>
    <div class="bg-head py-4">
      <div class="text-h4 font-weight-medium white--text text-center pb-2">
      ...
      <div class="link-pindah text-h6 d-flex justify-center  font-weight-regular white-text text-center pb-2">
        ...
        <nuxt-link to="/beranda/data-statistik" class="white--text text-decoration-none mr-5">Data Statistik</nuxt-link>
...
export default {
  ...
  methods: {
    async getses() {
      ...
      this.datalogin= this.sessionuser?.data?.user?.user_metadata?.username
